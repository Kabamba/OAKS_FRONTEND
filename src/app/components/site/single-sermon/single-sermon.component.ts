...
@Component({
  selector: 'app-single-sermon',
  templateUrl: './single-sermon.component.html',
  styleUrls: ['./single-sermon.component.css'],
})
export class SingleSermonComponent implements OnInit, AfterViewInit {
  sermon: any;
  others: any[] = [];
  ...
  getOthers(){
    this.serm.limit(8).subscribe((res:any)=>{
